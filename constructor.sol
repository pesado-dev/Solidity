...
contract X{
    string public name;
    uint256 immutable idade;//aqui declaramos essa variável como imutável depois setada
    //temos duas variáveis que não podem ser modificadas em solidity, a immutável que pode ser setada no constructor
    ...
    constructor(string memory _name, uint256 _idade){
        //no contrutor, já construimos o contrato declarando as variáveis
        name = _name;
        idade = _idade; 
    }
